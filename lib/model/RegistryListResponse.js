...
var RegistryListResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RegistryListResponse, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>RegistryListResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegistryListResponse</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RegistryItem["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = RegistryListResponse;
