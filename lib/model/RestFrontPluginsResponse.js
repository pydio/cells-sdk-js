...
var RestFrontPluginsResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestFrontPluginsResponse, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>RestFrontPluginsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestFrontPluginsResponse</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = RestFrontPluginsResponse;
