...
var RestLogMessageCollection = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestLogMessageCollection, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['Logs']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['Logs']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _LogLogMessage["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = RestLogMessageCollection;
