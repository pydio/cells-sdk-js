...
var UpdateUpdateResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(UpdateUpdateResponse, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['AvailableBinaries']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['AvailableBinaries']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _UpdatePackage["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = UpdateUpdateResponse;
