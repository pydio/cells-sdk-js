  ...
  return _createClass(EncryptionKeyInfo, null, [{
    ...
    value: function validateJSON(data) {
      if (data['Exports']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['Exports']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _EncryptionExport["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['Imports']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['Imports']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _item = _step2.value;
            _EncryptionImport["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
