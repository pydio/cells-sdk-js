...
var RestPagination = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestPagination, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>RestPagination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestPagination</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = RestPagination;
