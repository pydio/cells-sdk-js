...
var MailerSendMailResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(MailerSendMailResponse, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>MailerSendMailResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MailerSendMailResponse</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = MailerSendMailResponse;
