...
var IdmListPolicyGroupsResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(IdmListPolicyGroupsResponse, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['PolicyGroups']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['PolicyGroups']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _IdmPolicyGroup["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = IdmListPolicyGroupsResponse;
