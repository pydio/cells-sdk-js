...
var EncryptionAdminListKeysResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(EncryptionAdminListKeysResponse, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>EncryptionAdminListKeysResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EncryptionAdminListKeysResponse</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['Keys']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _EncryptionKey["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = EncryptionAdminListKeysResponse;
