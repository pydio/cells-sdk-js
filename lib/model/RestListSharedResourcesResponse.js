...
var RestListSharedResourcesResponse = /*#__PURE__*/function () {
  ...
  return _createClass(RestListSharedResourcesResponse, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>RestListSharedResourcesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestListSharedResourcesResponse</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['Resources']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ListSharedResourcesResponseSharedResource["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
