...
var RestCreatePeerFolderResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestCreatePeerFolderResponse, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>RestCreatePeerFolderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestCreatePeerFolderResponse</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data['Node']) {
        // data not null
        _TreeNode["default"].validateJSON(data['Node']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = RestCreatePeerFolderResponse;
