...
var RestRelationResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestRelationResponse, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['BelongsToTeams']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['BelongsToTeams']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _IdmRole["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['SharedCells']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['SharedCells']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _item = _step2.value;
            _IdmWorkspace["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = RestRelationResponse;
