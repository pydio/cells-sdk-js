...
var EncryptionImport = /*#__PURE__*/function () {
   ...
   */
  return _createClass(EncryptionImport, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>EncryptionImport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EncryptionImport</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = EncryptionImport;
