...
var IdmUpdateUserMetaNamespaceResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(IdmUpdateUserMetaNamespaceResponse, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['Namespaces']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['Namespaces']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _IdmUserMetaNamespace["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = IdmUpdateUserMetaNamespaceResponse;
