...
var RestCreateStorageBucketRequest = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestCreateStorageBucketRequest, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>RestCreateStorageBucketRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestCreateStorageBucketRequest</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data['DataSource']) {
        // data not null
        _ObjectDataSource["default"].validateJSON(data['DataSource']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = RestCreateStorageBucketRequest;
