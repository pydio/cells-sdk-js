...
var RestDataSourceCollection = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestDataSourceCollection, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['DataSources']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['DataSources']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ObjectDataSource["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = RestDataSourceCollection;
