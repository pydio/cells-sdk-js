...
var RestDeleteNodesResponse = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestDeleteNodesResponse, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>RestDeleteNodesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestDeleteNodesResponse</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      if (data['DeleteJobs']) {
        ...
        if (!Array.isArray(data['DeleteJobs'])) {
          throw new Error("Expected the field `DeleteJobs` to be an array in the JSON data but got " + data['DeleteJobs']);
        }
        // validate the optional field `DeleteJobs` (array)
        var _iterator = _createForOfIteratorHelper(data['DeleteJobs']),
          _step;
        try {
...
var _default = exports["default"] = RestDeleteNodesResponse;
