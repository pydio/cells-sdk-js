...
var RestSearchRoleRequest = /*#__PURE__*/function () {
   ...
   */
  return _createClass(RestSearchRoleRequest, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>RestSearchRoleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestSearchRoleRequest</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['Queries']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _IdmRoleSingleQuery["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = RestSearchRoleRequest;
