...
var JobsActionLog = /*#__PURE__*/function () {
  ...
  return _createClass(JobsActionLog, null, [{
    ...
    value: function validateJSON(data) {
      ...
      if (data['Action']) {
        // data not null
        _JobsAction["default"].validateJSON(data['Action']);
      }
      // validate the optional field `InputMessage`
      if (data['InputMessage']) {
        // data not null
        _JobsActionMessage["default"].validateJSON(data['InputMessage']);
      }
      // validate the optional field `OutputMessage`
      if (data['OutputMessage']) {
        // data not null
        _JobsActionMessage["default"].validateJSON(data['OutputMessage']);
      }
      return true;
    }
  }]);
