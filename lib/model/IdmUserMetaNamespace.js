...
var _IdmPromptOptions = _interopRequireDefault(require("./IdmPromptOptions"));
  ...
  return _createClass(IdmUserMetaNamespace, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('EnforceDefault')) {
          obj['EnforceDefault'] = _ApiClient["default"].convertToType(data['EnforceDefault'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('JsonSchema')) {
          obj['JsonSchema'] = _ApiClient["default"].convertToType(data['JsonSchema'], 'String');
        }
        ...
        if (data.hasOwnProperty('PromptOptions')) {
          obj['PromptOptions'] = _IdmPromptOptions["default"].constructFromObject(data['PromptOptions']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['PromptOptions']) {
        // data not null
        _IdmPromptOptions["default"].validateJSON(data['PromptOptions']);
      }
      return true;
    }
  }]);
