...
* @version 4.0
*/
var ConfigServiceApi = exports["default"] = /*#__PURE__*/function () {
  /**
  ...
  */
   ...
   */
  return _createClass(ConfigServiceApi, [{
    ...
    key: "createStorageBucketWithHttpInfo",
    value: function createStorageBucketWithHttpInfo(BucketName, body) {
      var postBody = body;
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = _RestCreateStorageBucketResponse["default"];
      return this.apiClient.callApi('/config/buckets/{BucketName}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function createStorageBucket(BucketName, body) {
      return this.createStorageBucketWithHttpInfo(BucketName, body).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
