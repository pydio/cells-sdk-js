...
var UserMetaServiceApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(UserMetaServiceApi, [{
    ...
    value: function getNamespaceSchemaWithHttpInfo() {
      var postBody = null;
      var pathParams = {};
      var queryParams = {};
      var headerParams = {};
    ...
    value: function getNamespaceSchema() {
      return this.getNamespaceSchemaWithHttpInfo().then(function (response_and_data) {
        return response_and_data.data;
      });
    }
