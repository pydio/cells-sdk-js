...
var TokenServiceApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(TokenServiceApi, [{
    ...
    value: function resetPasswordTokenWithHttpInfo(UserLogin) {
      var postBody = null; // verify the required parameter 'UserLogin' is set
    ...
    value: function resetPasswordToken(UserLogin) {
