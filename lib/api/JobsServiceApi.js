  ...
  */
  ...
  _createClass(JobsServiceApi, [{
    ...
    value: function listTasksLogsWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/jobs/tasks/logs', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * Technical Logs, in Json or CSV format
     * @param {module:model/LogListLogRequest} body 
    ...
    value: function userControlJobWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/jobs/user', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * Send Control Commands to one or many jobs / tasks
     * @param {module:model/JobsCtrlCommand} body 
    ...
    value: function userCreateJobWithHttpInfo(JobName, body) {
      ...
      return this.apiClient.callApi('/jobs/user/{JobName}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * Create a predefined job to be run directly
     * @param {String} JobName Name of the job to create in the user space
    ...
    value: function userDeleteTasksWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/jobs/tasks/delete', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * Send a control command to clean tasks on a given job
     * @param {module:model/JobsDeleteTasksRequest} body 
    ...
    value: function userListJobsWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/jobs/user', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * List jobs associated with current user
     * @param {module:model/JobsListJobsRequest} body 
